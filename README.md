...
- Automatically sets a BASS environmental variable for lower-latency audio (smaller ALSA buffer)
...
lazertweaks --update: Updates the script to the latest version from upstream (keeps a .bak backup).
